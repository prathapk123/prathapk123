...
class MinHeap:
        ...
        if not self.is_leaf_node(pos):
            if (self.heap_node[pos] < self.heap_node[self.left_child(pos)] or 
               self.heap_node[pos] < self.heap_node[self.right_child(pos)]):
                ...
                if self.heap_node[self.left_child(pos)] > self.heap_node[self.right_child(pos)]:
                    self.swap_nodes(self.left_child(pos),pos)
    ...
    def remove(self):  
        ...
        print(self.heap_node[self.front_node])
        print(self.heap_node[self.size])
...
if __name__ == "__main__":
    ...
    min_heap_tree.Print()
    min_heap_tree.build_max_heap()
    print("Max Heap Tree is Below ")
    min_heap_tree.Print()